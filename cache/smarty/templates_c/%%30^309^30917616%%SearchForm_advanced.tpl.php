<?php /* Smarty version 2.6.31, created on 2020-03-05 09:42:17
         compiled from cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 244, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 402, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 483, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Loc_Localidades/SearchForm_advanced.tpl', 258, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='pais_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAIS','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['pais_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['pais_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['pais_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['pais_paises_id_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['pais_paises_id_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['pais_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['pais_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"pais_paises_id_c_advanced","name":"pais_advanced"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['pais_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['pais_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['pais_paises_id_c_advanced']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='provincia_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROVINCIA','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['provincia_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['provincia_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['provincia_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['prov_provincias_id_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['prov_provincias_id_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['provincia_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['provincia_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"prov_provincias_id_c_advanced","name":"provincia_advanced"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['provincia_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['provincia_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['prov_provincias_id_c_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='municipio_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MUNICIPIO','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['municipio_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['municipio_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['municipio_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['muni_municipios_id_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['muni_municipios_id_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['municipio_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['municipio_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"muni_municipios_id_c_advanced","name":"municipio_advanced"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['municipio_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['municipio_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['muni_municipios_id_c_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo ''; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='latitud_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LATITUD','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['latitud_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['latitud_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['latitud_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['latitud_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['latitud_advanced']['name']; ?>
' size='30' 
...
' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='longitud_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LONGITUD','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['longitud_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['longitud_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['longitud_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['longitud_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['longitud_advanced']['name']; ?>
' size='30' 
...
' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Loc_Localidades'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_pais_advanced\']={"form":"search_form","method":"query","modules":["Pais_Paises"],"group":"or","field_list":["name","id"],"populate_list":["pais_advanced","pais_paises_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_provincia_advanced\']={"form":"search_form","method":"query","modules":["prov_Provincias"],"group":"or","field_list":["name","id"],"populate_list":["provincia_advanced","prov_provincias_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_municipio_advanced\']={"form":"search_form","method":"query","modules":["muni_Municipios"],"group":"or","field_list":["name","id"],"populate_list":["municipio_advanced","muni_municipios_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>