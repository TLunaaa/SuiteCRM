...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='pais_advanced'>{sugar_translate label='LBL_PAIS' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.pais_advanced.name}"  class="sqsEnabled"   id="{$fields.pais_advanced.name}" size="" value="{$fields.pais_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.pais_paises_id_c_advanced.name}" value="{$fields.pais_paises_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.pais_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.pais_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"pais_paises_id_c_advanced","name":"pais_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.pais_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.pais_advanced.name}.value = ''; this.form.{$fields.pais_paises_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='provincia_advanced'>{sugar_translate label='LBL_PROVINCIA' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.provincia_advanced.name}"  class="sqsEnabled"   id="{$fields.provincia_advanced.name}" size="" value="{$fields.provincia_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.prov_provincias_id_c_advanced.name}" value="{$fields.prov_provincias_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.provincia_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.provincia_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"prov_provincias_id_c_advanced","name":"provincia_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.provincia_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.provincia_advanced.name}.value = ''; this.form.{$fields.prov_provincias_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='municipio_advanced'>{sugar_translate label='LBL_MUNICIPIO' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.municipio_advanced.name}"  class="sqsEnabled"   id="{$fields.municipio_advanced.name}" size="" value="{$fields.municipio_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.muni_municipios_id_c_advanced.name}" value="{$fields.muni_municipios_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.municipio_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.municipio_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"muni_municipios_id_c_advanced","name":"municipio_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.municipio_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.municipio_advanced.name}.value = ''; this.form.{$fields.muni_municipios_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'>{sugar_translate label='LBL_DESCRIPTION' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
...
{literal}{/literal}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='latitud_advanced'>{sugar_translate label='LBL_LATITUD' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.latitud_advanced.value) <= 0}
{assign var="value" value=$fields.latitud_advanced.default_value }
{else}
{assign var="value" value=$fields.latitud_advanced.value }
{/if}  
<input type='text' name='{$fields.latitud_advanced.name}' 
    id='{$fields.latitud_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='longitud_advanced'>{sugar_translate label='LBL_LONGITUD' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.longitud_advanced.value) <= 0}
{assign var="value" value=$fields.longitud_advanced.default_value }
{else}
{assign var="value" value=$fields.longitud_advanced.value }
{/if}  
<input type='text' name='{$fields.longitud_advanced.name}' 
    id='{$fields.longitud_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='Loc_Localidades'}</label>
                            </div>
            <div class="form-item">
